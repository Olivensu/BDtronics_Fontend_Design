...
function ProductDetails({ product_data }) {
  const [activeTab, setActiveTab] = useState("details ৳ ");
  const [quantity, setQuantity] = useState(1);

  const firstImage =
    product_data.images.length > 0
      ? product_data.images[0].image
      : "/img/default-product.jpg";
  const price =
    product_data.productAttributes[0]?.discountedRetailPrice ||
    product_data.productAttributes[0]?.retailPrice;
  const stockAvailable = product_data.productAttributes.some(
    (attr) => attr.stockAmount > 0
  );
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="grid md:grid-cols-8 grid-cols-1 gap-4">
          <div className="col-span-3">
            ...
            />
            <ProductImgSlide images = {product_data.images}></ProductImgSlide>
          </div>
          <div className="max-w-3xl col-span-3 mx-auto p-6">
              ...
              <div className="flex items-center gap-2 mb-4">
                <div
                  className={`w-3 h-3 rounded-full ${
                    stockAvailable ? "bg-green" : "bg-red"
                  }`}
                ></div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <span className="text-gray-900">{product_data.sku}</span>
            </div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center">
                <button
                  ...
                  className="h-8 w-8 flex items-center justify-center bg-gray-light"
                >
            ...
            <div className="flex gap-4 mb-6">
              <button className="flex-1 bg-green text-white py-2 rounded-full font-bold">
                BUY NOW
              </button>
              <button className="flex-1 bg-red text-white py-2 rounded-full font-bold">
                ADD TO CART
              </button>
            </div>
          ...
          <div className="col-span-2">
            <div className="max-w-md bg-[#F3F4F6]">
              {/* Delivery Info */}
              <div className=" p-4 rounded-lg">
                ...
                <div className="">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <div>
                        <span className="font-medium">Inside Dhaka:</span> 1-2
                        days
                      </div>
                      <div>
                        <span className="font-medium">Express (Dhaka):</span> 24
                        hours
                      </div>
                      ...
                      <div className="mt-1">
                        <span className="font-medium">Outside Dhaka:</span> 2-3
                        days
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">
                        10:00AM to 7:00PM (Friday Closed)
                      </div>
                    </div>
                  </div>
      ...
      <div className="max-w-[1280px] mx-auto p-4 space-y-8">
        ...
        <div className="container mx-auto p-4 max-w-[1280px]">
          <div className="tabs tabs-boxed">
            ...
            <a
              className={`tab ${
                activeTab === "specifications" ? "tab-active" : ""
              }`}
          ...
          <div className="mt-4">
            {activeTab === "details" && (
              <div className="prose max-w-none">
                <p>
                  This electronics soldering fume absorber is designed to
                  provide a clean and safe working environment by effectively
                  removing harmful fumes generated during soldering processes.
                  Its compact form factor and efficient performance make it an
                  essential tool for electronics professionals and hobbyists
                  alike.
                </p>
              </div>
            )}
